...
const palpites = [
  ...
  { usuario_id: 7, nome: 'ICARO', gols_casa: 1, gols_fora: 2 },
  { usuario_id: 21, nome: 'JORGE', gols_casa: 0, gols_fora: 2 },
  { usuario_id: 26, nome: 'RODRIGUES', gols_casa: 1, gols_fora: 1 },
...
async function inserirPalpites() {
  ...
  try {
    ...
    console.log('📋 Inserindo palpites do jogo Atlético-MG x Palmeiras...\n');
