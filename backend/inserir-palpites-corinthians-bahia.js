...
const palpites = [
  { usuario_id: 8, nome: 'ALEXANDRE', gols_casa: 2, gols_fora: 1 },
  { usuario_id: 20, nome: 'ANDRÉ', gols_casa: 2, gols_fora: 1 },
  { usuario_id: 17, nome: 'ANTONIO', gols_casa: 1, gols_fora: 1 },
  { usuario_id: 19, nome: 'CASSIANO', gols_casa: 2, gols_fora: 1 },
  { usuario_id: 24, nome: 'DENNYS', gols_casa: 1, gols_fora: 1 },
  { usuario_id: 25, nome: 'DINEY', gols_casa: 2, gols_fora: 1 },
  { usuario_id: 22, nome: 'GILVAN', gols_casa: 2, gols_fora: 2 },
  { usuario_id: 7, nome: 'ICARO', gols_casa: 1, gols_fora: 1 },
  { usuario_id: 18, nome: 'JAIME', gols_casa: 2, gols_fora: 2 },
  { usuario_id: 21, nome: 'JORGE', gols_casa: 3, gols_fora: 1 },
  { usuario_id: 26, nome: 'RODRIGUES', gols_casa: 1, gols_fora: 0 },
  { usuario_id: 9, nome: 'RONALDO', gols_casa: 2, gols_fora: 1 },
  { usuario_id: 23, nome: 'SAMUEL', gols_casa: 1, gols_fora: 1 }
];
...
async function inserirPalpites() {
  ...
  try {
    ...
    console.log('📋 Inserindo palpites do jogo Corinthians x Bahia...\n');
    ...
    console.log('\n🔍 Verificação final (Placar real: 1 x 2):');
    ...
    verificacao.forEach((p, index) => {
      const acertou = (p.gols_casa === 1 && p.gols_fora === 2) ? '✅' : '';
