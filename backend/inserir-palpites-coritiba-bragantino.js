...
const palpites = [
  { usuario_id: 8, nome: 'ALEXANDRE', gols_casa: 1, gols_fora: 2 },
  ...
  { usuario_id: 22, nome: 'GILVAN', gols_casa: 2, gols_fora: 1 },
  ...
  { usuario_id: 9, nome: 'RONALDO', gols_casa: 1, gols_fora: 1 },
...
async function inserirPalpites() {
  ...
  try {
    ...
    console.log('📋 Inserindo palpites do jogo Coritiba x Bragantino...\n');
