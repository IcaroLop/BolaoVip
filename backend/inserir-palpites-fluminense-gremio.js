...
const palpites = [
  ...
  { usuario_id: 20, nome: 'ANDRÉ', gols_casa: 2, gols_fora: 0 },
  { usuario_id: 17, nome: 'ANTONIO', gols_casa: 2, gols_fora: 1 },
  ...
  { usuario_id: 26, nome: 'RODRIGUES', gols_casa: 2, gols_fora: 1 },
...
async function inserirPalpites() {
  ...
  try {
    ...
    console.log('📋 Inserindo palpites do jogo Fluminense x Grêmio...\n');
    ...
    console.log('\n🔍 Verificação final (Placar real: 2 x 1):');
