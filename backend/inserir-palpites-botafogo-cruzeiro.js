...
async function inserirPalpites() {
  ...
  try {
    ...
    console.log('📋 Inserindo palpites do jogo Botafogo x Cruzeiro...\n');
    ...
    // Verificação final
    console.log('\n🔍 Verificação final (Placar real: 4 x 0):');
    ...
    verificacao.forEach((p, index) => {
      const acertou = (p.gols_casa === 4 && p.gols_fora === 0) ? '✅' : '';
